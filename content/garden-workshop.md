...
Status: published
Summary: Design and construction of an office and workshop.
...
[Oakwood Garden Rooms](https://www.oakwoodgardenrooms.com/), whose
[YouTube channel](https://www.youtube.com/channel/UChqWFbSX8STP_c8W0RVW1Xw) provided
...
design and build, while making sure not to reveal any of the details supplied in the
...
relatively small amount of tolerance, and determine the overall size and
shape of the base.
...
piles and joists supported with hangers bridging between the frame timbers. 100
mm insulation is cut and inserted between the joists, and held in place from
below by treated batten fastened to the joists. All gaps were filled with
...
18 mm OSB, a 100 mm perimeter is built around the edge and rooflight openings.
...
installed by [County Flat Roofing](https://countyflatroofing.co.uk/). The
rooflights measure 1,200 x 900 mm external dimensions.
...
Bauder membrane, rooflight upstand and rooflight. The wall buildup consists of (starting
inside) 100 mm studwork, 12 mm OSB, waterproof membrane, two layers of 25 mm
roofing batten, and two layers of 20 mm cedar board. Neither buildup shows the
...
Positions of sockets, lights and wiring were marked out using tape.
...
were taped together with aluminium foil to create a single airtight surface.
...
Wiring for electrical and data sockets and all the lighting was pulled through
...
More details to be added as the finishing touches are completed...
