...
and articulate the complex picture of human environmental impacts as a way to
reflect on the situation we find ourselves in, and provide something to
...
terrestrial, freshwater and marine environments. Across of an estimated 8
million animal and plant species, of which 75% are insects, approximately 1
million are currently threatened with extinction. This rate of extinction is
estimated to be 10 to 100 times higher than any of the previous known six mass
extinction events in the history of Earth, leading to it being named the [Holocene
extinction][wiki-holocene-extinction].

The [WWF Living Planet Report 2020][wwf-living-planet] provides a similarly
stark assessment of the state of the world's ecosystems and lifeforms: since
1970 to 2016 there was been an average decline of 68% in populations of
mammals, birds, amphibians, reptiles and fish (not including insects) according
to its Living Planet Index, which aggregates data from 20,811 populations
representing 4,392 species globally. Rates of decline vary significantly by
...
A [2018 study][biomass-distribution] [found][biomass-distribution-summary] of
all mammals on Earth, 96% are livestock, 36% are humans and only 4% are wild
animals. Of birds, 70% are poultry and 30% are wild. These proportions
correspond to intensification of animal agriculture with losses since human
impacts on nature of 83% of wild terrestrial mammals, 80% of marine mammals,
50% of plants and 15% of fish.

Biodiversity and ecosystems encompass a complex set of issues so it is useful
to look at them in detail and the implications of declining biodiversity and
consequent ecosystem impacts on humans. Biodiversity relates to the variety of
genes, species and functional traits in an [ecosystem][ecosystems] (a community
of living things living in an environment, all interacting as a system), and it
is recognised that biodiversity affects the functioning of ecosystems, the
flows of energy, materials, minerals and water. In a
[nutshell][ecosystem-functioning], all ecosystems are powered by the sun's
energy, captured by photosynthesis, and this energy is transferred upwards
through the food web. Interactions between organisms and their environment
cycle nutrients, such as carbon and water. Humans are part of an ecosystem in
that we depend on plants and organisms to capture the sun's energy and convert
it into edible products, and human activities such as agriculture and forestry
management can be seen as manipulating ecosystems to increase the output of
particular provisions, but unfortunately often with effects that are
detrimental to other ecosystem aspects.
...
Global Assessment Report, the trend of 16 of these 19 categories is decline in
the last 50 years. Only energy, food, and raw materials have seen increases in
the level of provisioning to humans, but with these benefits are direct impacts
to other services corresponding to dramatic changes in land use and associated
...
billion), global trade has increased ten times and GDP has increased four
times. It is estimated there has been a 15% per-capita increase in consumption
globally and this is compounded by increasing levels of long-distance goods
transportation. Increased consumption, along with technological development, has
driven increased production of food, materials and fuels, and urbanisation,
reflected in global statistics:
...
direct exploitation is the primary driver, followed by land-/sea-use change.
Together these issues account for more than 50% of the global impact on nature,
but approximately 30% is this is attributable to three other significant
factors: **climate change**, **pollution** and **invasive alien species**.
<!-- UN summary -->
The UN Global Assessment Report summarises human impact thus: that 75% of the
Earth's land surface is now significantly altered, 66% of the oceans are
significantly altered, and that global indicators of the condition of
biodiversity and ecosystems indicate a 47% decrease from before human impacts,
with a continuing decline of approximately 4% per decade.
...
(Ecosystem [collapse][wiki-eco-collapse] is when processes and features
supporting life are reduced or disappear, typically leading to a drastic
reduction in the number of organisms living in an environment, and often mass
extinction.) Swiss Re frame frame this as a critical issue because they
estimate 55% of global GDP depends on high-functioning biodiversity and
...
<!---->
Compared with pre-industrial times, it
is estimated that 30% of global habitats have lost the ability to support
long-term survival for the species they support.
...
<!---->
Globally, [it is estimated][global-tree-density] that there has been a 46%
...
four times the land area of the UK) of tropical forest was lost in the period
...
emergence of new viruses deadly to humans.
<!---->
Of the remaining forecasts, 66% have been [subject to human impacts][fao-2020]
...
decreased by 50% since 1990 (an estimated 16 million hectares per year, compared with 10
million in 2015-2020), which is encouraging but still falls short of increasing
forest cover in the near term to mitigate climate change and to preserve
biodiversity.
...
areas such as reservoirs and rice paddies. Wetlands provide additional important
ecosystem services: water purification and a source of food. More than 85% have
been lost between 1700 (pre-industrial times) to 2000, and this has
accelerated: the rate of destruction has been approximately three times faster
than that of forests with 30% lost between 1970 and 2008. This destruction is
driven primarily by land-use change due to agriculture, but also climate
change, direct extraction and pollution. Globally, there are
[now approximately][wetland-area] 5.7 million square kilometres of wetlands, of
6% of global land area. Creation of artificial wetlands has also accelerated,
accounting for 12% of the total area.
...
that do not allow soil to naturally regenerate and abundantly use chemicals for
fertilisation and pest control. Secondary drivers are urbanisation, development
of infrastructure, production of energy and mining. The UN's [Global Land
Outlook report][global-land-outlook] states that over the last 20 years,
approximately 20% of land supporting the growth of plants shows persistent
declining trends in productivity (16% of forests, 19% of grasslands and 27% of
rangeland). The impacts vary significantly by region, with Africa and Europe
having some of the highest levels of land degradation, with effects of future
food production security, water security and reduced protection against extreme
weather events.

<!-- Pollution -->

Although land-use change and direct exploitation are dominant factors in the
declines in terrestrial nature, pollution, including the introduction of
invasive alien species, together account for more than 20% of the declines in
nature.
<!---->
...
since 1970, due mainly to the growth of long-distance goods transport.

Climate change, which is discussed in the last section, has a relatively
...
0.017-0.027 pH units per decade. Acidification is known to reduces the ability
...
remedy: if emissions of CO<sub>2</sub> were to stop today, we would see a lag
of one or more decades where acidification would continue and it is expected
that it would take tens to hundreds of thousands of years for the oceans to
return to a normal pH level. As a point of comparison, the largest extinction
event of marine life [occurred approximately 55 m years ago][PETM] when global
...
called [**hypoxic**][hypoxia] and below that **anoxic**, with these conditions
leading to the death of fish and invertebrates like worms and clams. In 2008,
it was estimated that there were 400 hypoxic or anoxic 'dead zones', totalling
245,000 km$2$. Compounding these issues are feedback effects: warming water
increases the metabolic rate of marine organisms that produce oxygen causing
them to respire more and generate less oxygen, and the lack of nutrients due to
stratification inhibits photosynthesis by organisms such as
[phytoplankton][phytoplankton] (microscopic organisms that create organic
compounds including oxygen from dissolved CO<sub>2</sub>).
...
**oxygen-minimum zone** out beyond the continental shelves. The result is a
narrow region of water on the the coast of the continents, with only the upper
...
for for reefs, sponges and shellfish. These factors have led to a situation
...
non-point sources such as land runoff, wind-blown debris, atmospheric emissions,
...
do discharge contaminants directly into waterways or by incineration, discharge
them as airborne particles that eventually settle; pesticides are widely used
in plant agriculture and antibiotics and growth hormones in livestock
agriculture; transport produces substantial oil and rubber residues; and
domestic use of a variety of chemicals and medicines leads to contaminants
eventually finding their way into watercourses. To give one example it is
estimated that the amount of plastic pollution has increased tenfold since
1980, and that 4 to 12 million tonnes of plastic entered the oceans in just one
year in 2010. The [Great Pacific Garbage Patch][GPGP] is estimated to be
700,000 square km and containing 80,000 tonnes of waste.
...
Global warming induced climate change has a broad impact on nature and
...
anthropogenic emissions (hazardous emissions caused by humans), as shown by
the charts below. Atmospheric concentration of carbon dioxide (CO<sub>2</sub>)
is at 408 parts per million and 147% more than pre-industrial levels (PIL, of
...
the global mean temperature and the global mean sea are 1.2C and 20 cm higher
than PIL with year-on-year records being set. Temperature and sea-level rises
are variable across the globe, for instance the Arctic has been experiencing
sustained higher-than-average temperatures. The global oxygen (O<sub>2</sub>)
level has been declining since it was first measured in 1991, approximately
0.05% higher than the present day.
...
{{ macros.image('nature/NSIDC-arctic-sea-ice-extent-2012.png', size='w=300',
 ...
 - **Higher average temperatures**, with increases being 2 to 3 times greater in some regions.
 - More frequent **ice-free Arctic**, once per decade rather than once per century, with
   ...
   2020 has continued the trend with a [later-than ever][oct-2020-arctic] ice-free arctic.
   Similar reductions in ice affect polar mountain glaciers and ice sheets.
...
These effects have consequent impacts in terrestrial ecosystems:
 ...
 - **Species habitat loss** through reduction in their climatically determined
...
{{ macros.pair_layout(
    macros.image('nature/CAT-Graph-2030EmissionsGaps-2019.12.original.png', size='w=500',
                 caption='Climate Action Tracker 2030 emissions gaps.'),
    macros.image('nature/CAT-2100WarmingProjectionsGraph-2019.12.original.png', size='w=500',
...
- [One Ocean Project, issue briefs](https://www.oceanprotect.org/resources/issue-briefs/)
