...
are damaging our environment so severely that the future of our life on Earth is
...
reflect on the situation in which we find ourselves, and provide something to
...
100 times higher than any of the five previously known mass extinction events in
...
1970 and 2016 there has been an average decline of 68% in populations of
...
A [2018 study][biomass-distribution] [found][biomass-distribution-summary] that
of all mammals on Earth, 60% are livestock, 36% are humans and only 4% are wild
...
exchange them through their interactions with the physical environment.
...
supporting and cultural, summarised in the following table. According to the
Global Assessment Report, the trend in 16 of these 19 categories has been
...
<table>
  <caption>
  Summary of the ecosystem services nature provides to humans
  </caption>
  <thead>
    <tr>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="text-danger">Decline</td>
      <td>For example, new antibiotics are discovered in nature, rather than being created artificially.</td>
    </tr>
    <!-- -->
    ...
    <tr>
      ...
      <td class="text-danger">Decline</td>
      <td>Examples include shade from trees, forests influencing rainfall and plants regulating air quality by removing pollutants.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="text-danger">Decline</td>
      <td>Such as treatment of wastewater to eliminate harmful pathogens.</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>Tourism through the enjoyment of nature</td>
      <td class="text-danger">Decline</td>
...
billion), global trade has increased tenfold and average GDP has increased
fourfold. It is estimated there has been a 15% per-capita increase in
...
global impact on nature, but approximately 30% is attributable to three
other significant factors: **climate change**, **pollution** and **invasive
alien species**.
<!-- UN summary -->
The UN Global Assessment Report summarises human impact thus: 75% of the
...
this production that it is responsible for 25% of greenhouse gas emissions (18%
...
reduction in the number of trees compared with before human impacts, and approximately 10
...
than 85% have been lost between 1700 (pre-industrial times) and 2000, and this
...
chemicals released into the air (including greenhouse gases causing global
...
<!---->
The introduction of invasive terrestrial species has risen approximately 70%
...
outcompete native wildlife or prey on it. They can cause indirect detrimental effects
...
The vastness of the oceans has provided a significant buffer against the
effects of global warming by absorbing huge quantities of CO<sub>2</sub> and heat.
Between 2009 and 2018, the oceans absorbed 23% of global CO<sub>2</sub> emissions;
...
and their ecosystems are not yet well understood. This situation is not easy to
...
0.11 C per decade rise in the upper 75 m of water (0.09-0.13 C). The effects of **ocean
...
marine life, such as corals and algae, of food.
...
phytoplankton and other algae rapidly multiply to create huge blooms. These
...
frequent and more toxic; in 2018 there were [300
...
is a vast array of non-nutrient pollutants, each with their own harmful
...
discharge contaminants directly into waterways or, by incineration, as
airborne particles that eventually settle. For example:
...
estimated to be 700,000 square km and to contain 80,000 tonnes of waste.
...
Climate change induced by global warming has a broad impact on nature and
...
at 408 parts per million and 147% of pre-industrial levels (PIL, of
which 1750 is used as a representative baseline); methane (CH<sub>4</sub>) is
at 1,870 parts per billion and 259% of PIL; and nitrous oxide
...
Historical emissions of greenhouse gases are likely to cause further warming
...
emissions. This puts us on a pathway of 1.5-2 C warming and beyond,
which is predicted to have significantly worse effects compared with 1.5C by
...
{{ macros.image('nature/NSIDC-arctic-sea-ice-extent-2012.png', size='w=300',
 ...
 - More frequent **extreme weather events** including heatwaves, heavy precipitation,
   severe drought, with effects including large-scale wildfires and flooding.
 ...
 - More frequent **ice-free Arctic**, once per decade rather than once per century, with
   ...
   2020 has continued the trend, with Arctic sea ice [refreezing later than
   ever][oct-2020-arctic]. Similar reductions in ice affect polar mountain glaciers and ice sheets.
 - Increased **sea level rise** driven by ocean warming and melting ice: 10 cm
 ...
 - Potential to trigger **instabilities in the Greenland and Antarctic ice
   sheets**, which would result in multi-metre sea-level rises.
...
On water resources:
 ...
 - Reduced **food security** caused by reduced crop yields, reduced fisheries
   (twice the level of decline compared with 1.5C) and reduced livestock
   production.
...
And impact humans as well:
 ...
 - More **pest species** such as mosquitoes and ticks that spread disease, and locusts
...
similar reductions in gases such as methane, but policy and aspirations fall
...
to 1.5 C under the Paris agreement and 30% short for 2 C.
...
ecosystem services are generally poorly understood and not regarded as risks, yet
...
to become catastrophic is just a blink of an eye. Even if things changed
...
transformative change across economic, social, political and
...
- [Climate Levels](https://www.climatelevels.org/), live graphs of atmospheric concentrations of greenhouse gases and global mean temperature, sea level and oxygen level.
