...
Tags: self-hosted
Summary: Details of how I self-host services to maintain a degree of
...
- To have complete control over my personal data, giving me flexibility over
  ...
  computing devices. Anything that I can download from a cloud service, I aim to
  back up on my own storage, or master it there if I no longer require access via
  the cloud service.
...
- To have independence from companies that (a) offer free services in return
  ...
  user so it is hard to move to another service and (c) end-of-life services that I
  come to rely on.
...
happen in an accident or fire. To mitigate this, I have set up an off-site backup
using another Synology DiskStation NAS. A full incremental backup
is performed nightly using Synology's Hyper Backup. I have checked that files
...
3400GE processor with 16 GB DDR4 RAM and a 500 GB NVMe SSD. You can pick these
...
Using the Synology VPN Server on the DS220+, I have an OpenVPN service set up that
...
- [DigitalOcean](https://www.digitalocean.com) for object storage with Spaces.
- [Google Docs and Sheets](https://docs.google.com) for word processing and spreadsheets.
...
locked out of my account. Although these scenarios are unlikely, I mitigate the
risks by taking manual backups, albeit on a less frequent basis than I should.


## Summary

This note details hardware and software alternatives for operating personal services
that are easy to set up and maintain, with scope to add much more functionality. This
