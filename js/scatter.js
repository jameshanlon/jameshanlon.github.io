// Based on 'D3 scatter plot example', http://bl.ocks.org/weiglemc/6185069.
...
// setup y
var yValue = function(d) { return d.Cores;}, // data -> value
...
d3.csv("processors/dataset.csv", function(error, data) {
  ...
  // Draw dots, excluding zero-valued ones.
  svg.selectAll(".dot")
      .data(data)
    .enter().append("circle")
      .attr("class", "dot")
      ...
      .on("mouseover", function(d) {
          tooltip.transition()
               ...
               .style("opacity", .75);
          tooltip.html(
              d.Designer + "<br>" + d.Architecture + ", " + d.Model +
              "<br/> " +  yValue(d) + " cores (" + xValue(d) + ")")
